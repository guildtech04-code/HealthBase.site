...
<body>
    ...
    <form id="login-form" action="debug_auth.php" method="POST">
    ...
    <div class="debug">
        ...
        <p><a href="../force_redirect_test.php">Force Redirect Test</a></p>
    </div>
    ...
    <script>
        ...
        document.getElementById('login-form').action += '?t=' + Date.now();
    </script>
</body>
</html>
